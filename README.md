...
- [API](#api)
  - [`crypto.aes`](#cryptoaes)
    - [`create(key, iv)`](#cryptoaescreatekey-iv)
      - [`decrypt(data)`](#decryptdata)
      - [`encrypt(data)`](#encryptdata)
  - [`crypto.hmac`](#cryptohmac)
    - [`create(hash, secret)`](#createhash-secret)
      - [`digest(data)`](#digestdata)
  - [`crypto.keys`](#cryptokeys)
    - [`generateKeyPair(type, bits)`](#cryptokeysgeneratekeypairtype-bits)
    - [`generateEphemeralKeyPair(curve)`](#cryptokeysgenerateephemeralkeypaircurve)
    - [`keyStretcher(cipherType, hashType, secret)`](#cryptokeyskeystretcherciphertype-hashtype-secret)
    - [`marshalPublicKey(key, [type])`](#cryptokeysmarshalpublickeykey-type)
    - [`unmarshalPublicKey(buf)`](#cryptokeysunmarshalpublickeybuf)
    - [`marshalPrivateKey(key, [type])`](#cryptokeysmarshalprivatekeykey-type)
    - [`unmarshalPrivateKey(buf)`](#cryptokeysunmarshalprivatekeybuf)
    - [`import(pem, password)`](#cryptokeysimportpem-password)
